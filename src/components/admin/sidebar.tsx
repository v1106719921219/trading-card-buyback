...
const navItems = [
  ...
  { href: '/admin/marketing/text-special-box', label: 'スペシャルBOX投稿文', icon: Megaphone },
  { href: '/admin/marketing/text-onepiece', label: 'ワンピBOX投稿文', icon: Megaphone },
  ...
  { href: '/admin/marketing/image-special-box', label: 'スペシャルBOX画像', icon: ImageIcon },
