...
const navItems = [
  ...
  { href: '/admin/marketing', label: 'BOX投稿文生成', icon: Megaphone },
  { href: '/admin/marketing/text-single', label: 'シングル投稿文生成', icon: Megaphone },
  { href: '/admin/marketing/image', label: 'BOX価格画像生成', icon: ImageIcon },
  { href: '/admin/marketing/image-single', label: 'シングル価格画像生成', icon: ImageIcon },
